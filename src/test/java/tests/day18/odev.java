...
public class odev {
    ...
    // 4. Username textbox ve password metin kutularını locate edin ve
    // aşağıdaki verileri girin. a. Username : manager b. Password : Manager1!
    // 5. Login butonuna tıklayın. 6. Hotel Management menusunden Add Hotelroom butonuna tıklayın.
